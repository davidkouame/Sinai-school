...
<!--<div class=\"float-right\" style=\"margin-right: 12px;\"><b>Publié le {{ clubActivite.created_at|date(\"d-m-Y\") }}</b></div>-->", "/Applications/MAMP/htdocs/Sinai-school/plugins/bootnetcrasher/school/components/detailclubsactivites/default.htm", "");
    }
}
